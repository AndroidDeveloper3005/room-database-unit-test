...
import com.github.androiddeveloper3005.roomdatabase_testing.other.Constants.GRID_SPIN_COUNT
...
class ImagePickFragment @Inject constructor(
    ...
    private fun setUpRecyclerView(){
        rvImages.apply {
            ...
            layoutManager = GridLayoutManager(requireContext(), GRID_SPIN_COUNT)
        }
